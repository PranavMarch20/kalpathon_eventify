          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[250px]">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 bg-gradient-to-br from-[#4F46E5] to-[#7c3aed] rounded-[2rem] p-8 md:p-10 relative overflow-hidden group shadow-xl">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                {/* Decorative Mockup */}
                <div className="mt-2 md:mt-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 transform md:translate-y-12 opacity-80 h-[170px] md:h-auto group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 shadow-xl">
